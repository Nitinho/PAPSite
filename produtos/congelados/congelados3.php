...
$categoria = "outroscongelado"; // Ajuste conforme necessário
...
<body>
    ...
    <main>
        ...
        <div class="sidebar">
                ...
                <li><a href="congelados3.php" class="active"><i class="fas fa-box-open"></i>Outros</a></li>
