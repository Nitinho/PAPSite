...
$categoria = "peixecarnecongelado"; // Ajuste conforme necessário
...
<head>
    ...
    <title>Congelados | Peixe e Carne</title>
...
<body>
    ...
    <div class="page-banner">
        <div class="banner-content">
            <h1>Congelados</h1>
            <p>Descubra nossa seleção de congelados</p>
        </div>
    </div>
    ...
    <main>
        ...
        <div class="sidebar">
                <h3>Categorias</h3>
                <ul>
                <li><a href="congelados.php"><i class="fas fa-ice-cream"></i>Doces</a></li>
                <li><a href="congelados2.php" class="active"><i class="fas fa-snowflake"></i>Carnes e Peixes</a></li>
