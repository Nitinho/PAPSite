...
<head>
    ...
    <title>Frescos | Talho</title>
    <meta name="description" content="Produtos de talho de alta qualidade dos Armazéns Lopes">
...
<body>
    ...
    <div class="page-banner">
        <div class="banner-content">
            <h1>Talho</h1>
            <p>Descubra nossa seleção de carnes</p>
        </div>
    </div>
    ...
    <main>
        <div class="main-container">
            <div class="sidebar">
                <h3>Categorias</h3>
                <ul>
                    <li><a href="frescos.php" class="active"><i class="fas fa-drumstick-bite" aria-hidden="true"></i>Talho</a></li>
