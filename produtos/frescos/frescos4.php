...
$categoria = "frutas"; // Ajuste conforme necessário
...
<body>
    ...
    <div class="page-banner">
        <div class="banner-content">
            <h1>Frutas</h1>
            <p>Descubra nossa seleção de Frutas</p>
        </div>
    </div>
        ...
        <div class="main-container">
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="frescos4.php" class="active"><i class="fas fa-apple-alt" aria-hidden="true"></i>Frutas</a></li>
