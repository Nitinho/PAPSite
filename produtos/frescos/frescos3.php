...
$categoria = "legumes"; // Ajuste conforme necessário
...
<body>
    ...
    <div class="page-banner">
        <div class="banner-content">
            <h1>Legumes</h1>
            <p>Descubra nossa seleção de legumes</p>
        </div>
    </div>
        ...
        <div class="main-container">
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="frescos2.php"><i class="fas fa-fish" aria-hidden="true"></i>Peixe e Marisco</a></li>
                    <li><a href="frescos3.php" class="active"><i class="fas fa-carrot" aria-hidden="true"></i>Legumes</a></li>
