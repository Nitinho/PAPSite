...
$categoria = "bebidassemalcool"; // Ajuste conforme necessário
    ...
    <main>
        <div class="main-container">
            <div class="sidebar">
                <h3>Categorias</h3>
                <ul>
                    <li><a href="bebidas.php" class="active"><i class="fas fa-glass-water"></i>Bebidas não Alcoólicas</a></li>
                    <li><a href="bebidas2.php"><i class="fas fa-wine-glass"></i>Bebidas Alcoólicas</a></li>
                </ul>
