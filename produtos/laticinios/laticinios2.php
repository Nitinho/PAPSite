...
$categoria = "iogurte"; // Ajuste conforme necessário
...
<head>
    ...
    <title>Armázem Lopes | Iogurtes</title>
...
<body>
    ...
    <div class="page-banner">
        <div class="banner-content">
            <h1>Iogurtes</h1>
            <p>Descubra nossa seleção de Iogurtes</p>
        </div>
    </div>
        ...
        <div class="main-container">
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="laticinios2.php" class="active"><i class="fas fa-prescription-bottle" aria-hidden="true"></i>Iogurtes</a></li>
