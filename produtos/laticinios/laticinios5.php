...
$categoria = "queijo"; // Ajuste conforme necessário
...
<head>
    ...
    <title>Armázem Lopes | Queijos</title>
...
<body>
    ...
    <div class="page-banner">
        <div class="banner-content">
            <h1>Queijos</h1>
            <p>Descubra nossa seleção de Queijos</p>
        </div>
    </div>
        ...
        <div class="main-container">
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="laticinios5.php" class="active"><i class="fas fa-cheese" aria-hidden="true"></i>Queijos</a></li>
