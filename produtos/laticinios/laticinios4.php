...
$categoria = "natas"; // Ajuste conforme necessário
...
<head>
    ...
    <title>Armázem Lopes | Natas e Cremes</title>
...
<body>
    ...
    <div class="page-banner">
        <div class="banner-content">
            <h1>Natas e Cremes</h1>
            <p>Descubra nossa seleção de Natas e Cremes</p>
        </div>
    </div>
        ...
        <div class="main-container">
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="laticinios4.php" class="active" ><i class="fas fa-wine-glass" aria-hidden="true"></i>Natas e Cremes</a></li>
