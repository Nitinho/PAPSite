...
$categoria = "ovos"; // Ajuste conforme necessário
...
<head>
    ...
    <title>Armázem Lopes | Ovos</title>
...
<body>
    ...
    <div class="page-banner">
        <div class="banner-content">
            <h1>Ovos</h1>
            <p>Descubra nossa seleção de Ovos</p>
        </div>
    </div>
        ...
        <div class="main-container">
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="laticinios6.php" class="active"><i class="fas fa-egg" aria-hidden="true"></i>Ovos</a></li>
