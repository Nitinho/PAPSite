...
$categoria = "manteiga"; // Ajuste conforme necessário
...
<head>
    ...
    <title>Armázem Lopes | manteigas</title>
...
<body>
    ...
    <div class="page-banner">
        <div class="banner-content">
            <h1>Manteigas e Cremes Vegetais</h1>
            <p>Descubra nossa seleção de Manteigas e Cremes Vegetais</p>
        </div>
    </div>
    ...
    <main>
        <div class="main-container">
            <div class="sidebar">
                <h3>Categorias</h3>
                <ul>
                    <li><a href="laticinios.php"><i class="fas fa-tint" aria-hidden="true"></i>Leite</a></li>
                    <li><a href="laticinios2.php"><i class="fas fa-prescription-bottle" aria-hidden="true"></i>Iogurtes</a></li>
                    <li><a href="laticinios3.php" class="active"><i class="fas fa-cube" aria-hidden="true"></i>Manteigas e Cremes Vegetais</a></li>
