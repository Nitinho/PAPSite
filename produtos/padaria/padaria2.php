...
$categoria = "pastelaria"; // Ajuste conforme necessário
    ...
    <main>
        <div class="main-container">
            <div class="sidebar">
                <h3>Categorias</h3>
                <ul>
                <li><a href="padaria1.php"><i class="fas fa-bread-slice"></i>Padaria</a></li>
                <li><a href="padaria2.php" class="active"><i class="fas fa-birthday-cake"></i>Pastelaria</a></li>
                </ul>
