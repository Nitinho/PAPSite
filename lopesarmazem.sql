...
-- A despejar dados para tabela lopesarmazem.compras: ~2 rows (aproximadamente)
INSERT INTO `compras` (`id`, `usuario_id`, `data_compra`, `valor_compra`, `pontos_ganhos`, `status`, `data_cancelamento`) VALUES
	(8, 1, '2025-04-23 08:51:38', 81.85, 8, 'recebido', NULL),
	(9, 1, '2025-04-23 12:05:39', 7.50, 0, 'pendente', NULL);
...
-- A despejar dados para tabela lopesarmazem.itens_compra: ~11 rows (aproximadamente)
...
-- A despejar dados para tabela lopesarmazem.support_messages: ~3 rows (aproximadamente)
...
-- A despejar dados para tabela lopesarmazem.usuarios: ~2 rows (aproximadamente)
